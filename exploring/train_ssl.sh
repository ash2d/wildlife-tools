...
srun uv run train_dinov2_selfsupervised.py --csv '/home/users/dash/guppies/embeddings/wildlife-tools/exploring/csvs/no_id_10000.csv' --epochs 10 --root '/gws/nopw/j04/iecdt/dash/cropped_images/no_id/images_w_box' --output-dir '/gws/nopw/j04/iecdt/dash/embeddings/models' --log-file '/home/users/dash/guppies/embeddings/wildlife-tools/exploring/logs/dinossl/3.txt'